...
- Close other large apps if your PC runs slowly
...
9. If the app asks for setup details, enter them in the fields shown on screen.
...
- `.exe` — the main app file
- `.zip` — a compressed folder that must be extracted
- `.dll` — a support file that the app may need
- `.json` — a settings or config file
- `.txt` — a plain text file with notes
...
- Use a short folder path, such as `C:\Apps\open-claude-code`
- Avoid placing the app in a folder with special characters
...
- Extracted app folder: `Desktop\open-claude-code`
- Project folder: `Documents\MyProject`
